 ...
 * @returns {*}
 */
export function sendEvent(event:string,data:any): Promise<string> {
  return Uni.sendEvent(event,data);
}
/**
 * 获取当前小程序的直连url
 * @returns {*}
 ...
 * @returns {*}
 */
 export function hideCurrentApp(): Promise<boolean> {
  return Uni.hideCurrentApp();
}
 ...
 * @returns {*}
 */
 export function showCurrentApp(appid): Promise<boolean> {
  return Platform.OS === 'ios'
  ? Uni.showCurrentApp()
  : Uni.showCurrentApp(appid);
}
 ...
 * @returns {EmitterSubscription}
 */
export function onAppCapsuleClose(cb: () => void) {
